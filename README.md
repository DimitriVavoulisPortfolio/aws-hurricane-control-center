...
The Hurricane Control Center is an advanced system that provides real-time monitoring and notifications about potential hurricane threats to users in Puerto Rico and Florida. It leverages NOAA data to analyze, visualize, and notify subscribers about approaching storms. The system is built using AWS services. The core functionality runs daily at 8 AM EST to ensure up-to-date information. This is currently at stage 2, it will be further developed over time.
